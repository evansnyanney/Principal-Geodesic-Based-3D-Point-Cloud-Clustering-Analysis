...
def perform_statistical_tests(cluster_variance_stats):
    variance_x = [
        stats["all_variances"][:, 0] for stats in cluster_variance_stats.values()
    ]
    variance_y = [
        stats["all_variances"][:, 1] for stats in cluster_variance_stats.values()
    ]
    variance_z = [
        stats["all_variances"][:, 2] for stats in cluster_variance_stats.values()
    ]
